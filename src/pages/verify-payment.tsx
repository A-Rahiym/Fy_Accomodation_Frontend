      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <Card className="bg-yellow-50 border-yellow-200">
          <CardContent className="p-4">
            <p className="text-yellow-800 font-medium">
              Testing Environment: This page is for development only and does
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Upload evidence of your school fees payment for verification
          </p>
        </div>
        ...
        <Card className="bg-blue-50 border-blue-200">
          <CardContent className="p-4">
            <p className="text-blue-800 text-sm">
              <strong>Payment Verification:</strong> Upload your payment receipt
              and we'll verify your payment status automatically. Once verified,
              you'll be able to proceed with hostel selection.
            </p>
          </CardContent>
        </Card>
                ...
                <div className="flex-1">
                  ...
                  {submitStatus.type === "success" && (
                    <div className="mt-4 flex flex-col sm:flex-row gap-3">
                      <Button
                        onClick={() => navigate("/hostel-selection")}
